...
import { ArrowLeft, Trophy, Shield, Swords } from 'lucide-react'
        ...
        <div className="flex items-start justify-between flex-wrap gap-4">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-xl bg-accent-purple/10 flex items-center justify-center flex-shrink-0"
              ...
              <Trophy size={26} className="text-accent-purple" />
            </div>
            <div>
              ...
              <p className="font-body text-sm text-text-muted mt-0.5">
                {tournament.game} · {teams.length} teams · {matches.length} matches
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 glass-card p-5">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="font-display text-sm text-text-primary uppercase tracking-wide">Participating Teams</h2>
                  ...
                  <Link key={t.id} to={`/teams/${t.id}`}
                    ...
                    <div className="flex items-center gap-4 flex-shrink-0">
                      <div className="flex gap-3 font-body text-xs">
                        ...
                        <span className="text-accent-cyan">{t.draws ?? 0}D</span>
